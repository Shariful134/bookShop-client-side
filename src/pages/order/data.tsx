      ...
      {isLoading ? (
        ...
        <div className="container mx-auto px-10">
          ...
          <div className="grid gap-6 md:grid-cols-2 ">
            ...
            <Card className="bg-[#e9e4dd]">
              <CardHeader>
                <CardTitle className="">Verification Status</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="flex items-center gap-2 font-(family-name:Poppins)">
              ...
              <CardFooter>
                <Link to="/get-orders">
                  <Button className="btn font-(family-name:Poppins) text-black border-1 font-serif rounded-full border-gray-600 bg-amber-100 hover:bg-amber-200 sm:btn-sm md:btn-md mt-2 bg ">
                    View Orders
                  </Button>
                </Link>
              </CardFooter>
